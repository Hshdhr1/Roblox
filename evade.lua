...
local Window = Rayfield:CreateWindow({
    Name = "Evade Hub (.gg/6UaRDjBY42)",
    LoadingTitle = "Evade (Summer Event) :)",
    LoadingSubtitle = "by @Ne_Xomyahok Team",
    ShowText = "Evade Hub",
   ...
   KeySystem = false, 
   KeySettings = {
      Title = "Evade Keysystem",
      Subtitle = "ку чушка  :)",
      Note = "ключ key так и пиши key", 
      FileName = "EvadeKey", 
      SaveKey = false, 
...
MainTab:CreateToggle({
    Name = "Auto Farm летнего ивента(вроде закончился)",
    CurrentValue = false,
    Flag = "AutoSummer",
    Callback = function(Value)
